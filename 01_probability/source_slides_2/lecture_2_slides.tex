...
\begin{frame}{Subsets of size $r$}
  ...
  \crish$$n\times (n-1)\times \ldots (n-r+1)=\frac{n\time (n-1)\times \ldots (n-r+1)\cblu\times (n-r)\times (n-r-1)\times \ldots \times 2 \times 1\crish}{\cblu{}(n-r)\times (n-r-1)\times \ldots \times 2 \times 1\crish}=\frac{n!}{(n-r)!}$$\cbla{}$$\cbla{}
